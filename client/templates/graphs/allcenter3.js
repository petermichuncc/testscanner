...
Template.allworkcell3.topGenresChart = function() {
...
{Session.set("loading",0)
    ...
    return {
        ...
        title: {
            text: "Averages for all workcenters Page 3"
        },
         xAxis: {
            categories: ["2039","2060","2071","2091","2092","6020","6021","6105","6234","6304","6305","6308","6315","6316","6318"],
            min: 0,
            max:15,
            labels: {
                style: {
